...
SDMT = Figlet(font="whimsy").renderText("S  D   M")
print((text(SDMT)))
SDMX='تـم تسـيجيل الدخول رست الاداة'
SDMXX='ڪوڪيز محظور او بدا لحساب الي جاي تستخرج منة ڪوڪيز'
import requests,bs4,json,os,sys,random,datetime,time,re
import urllib3,rich,base64
from rich.table import Table as me
from rich.console import Console as sol
...
SDMX='تـم تسـيجيل الدخول رست الاداة'
SDMXX='ڪوڪيز محظور او بدا لحساب الي جاي تستخرج منة ڪوڪيز'
import bs4,re,time,requests,datetime,os,sys,random,platform,uuid,mechanize,json
...
try:
	...
	open('.prox_wdeh.txt','w').write(prox)
...
F = '\033[1;32m' #اخضر
print(O+' ')
table = Table(title="البـرمـَج نــمرود",style="blue")
table.add_row("𝐌𝐘 𝗨𝐒𝐄𝐑 𝐓𝐄l𝐄𝐆𝐑𝐀𝐌 : @𝐌_𝐓_𝐅 ۦٰ‏",style='green')
table.add_row(" ",style='green')
table.add_row("ᗰY ᑕᕼᗩᑎᑎEᒪ  TEᒪE : @ᑭY_1ᕼOᑎ،",style='purple')
table.add_row(" ",style='green')
console = Console()
console.print(table)
print(O+' '*20)
token=input('\x1b[38;5;48m[ 𓆩𝐒𝐃𝐌-𝐕𝐈𝐏𓆪 ] TOKEN : \x1b[38;5;172m')
print('\n')
ID=input('\x1b[38;5;48m[ 𓆩𝐒𝐃𝐌-𝐕𝐈𝐏𓆪 ] ID : \x1b[38;5;172m')
print('\n')
...
def SDM():
	try:
		token = open('.M_T_F.txt','r').read()
		cok = open('.NSDM.txt','r').read()
...
def SDMB_lagi334():
	try:		
		os.system('clear')
		cookie=input(f' - ضـع مفـتاح ڪوڪيز  : ')
		open(".NSDM.txt", "w").write(cookie)
		...
		os.system("rm -f .M_T_F.txt")
		os.system("rm -f .NSDM.txt")
		exit()
def banner():
	pass		
def menu(sy2,sy3):
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠉⠉⠀⠀      ⠀⠀⠀⠀⠀⠀
''')
	print('❆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━❆\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t \x1b[1;32m(\x1b[1;35m+\x1b[1;32m) \x1b[1;33m 𝚃𝙴𝙻𝙴\x1b[1;35m | \x1b[1;32m @M_T_F  \x1b[1;35m (\x1b[1;32m+\x1b[1;35m) \x1b[1;33m   NAME  \x1b[1;35m | \x1b[1;32m 𓆩𝐒𝐃𝐌-𝐕𝐈𝐏𓆪 \n\x1b[1;35m❆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━❆')
	print('')
	print('\x1b[38;5;209m⇼'*60)
	print('   ') 
	print('\x1b[38;5;208m» 1- Fishing from friends : من الاصدقاء  ')
	print('   ') 
	print('   ') 
	print('» 0- ʟᴏɢɪɴ ᴏᴜᴛ  : تسجيل خروج   ')
	print('   ') 
	print('\x1b[38;5;209m⇼'*60)
...
def dump_massal():
	try:
	    ...
	    exit()
	try:
		SDMVIP1 = int(input(f'\033[2;36m\n\n𓆩𝐒𝐃𝐌-𝐕𝐈𝐏𓆪 || ڪم ايدي تـريد تصـيد علية؟: '))
		webbrowser.open('https://t.me/py_1hon')
	except ValueError:
	    exit()
	if SDMVIP1<1 or SDMVIP1>100:
	    exit()
	ses=requests.Session()
	bilangan = 0
	for KOTG49H in range(SDMVIP1):
		bilangan+=1
		Masukan = input(f'\033[1;32m\n-ايـدي لـ '+str(bilangan)+f' : ')
		uid.append(Masukan)
	for user in uid:
	    try:
	...
	try:
		cetak(nel(f'\n━عدد الايديات مستخرجة. '+str(len(id))))
		setting()
	except requests.exceptions.ConnectionError:
		print()
def setting():
...
\n(🏴༒🔱 نمــࢪود 🔱༒)  𖣬 \n:『@M_T_F 』⏎'\n\n\t\t\t\t\t
					'''
					SDMF = nel(statusok, style='green')
					cetak(nel(SDMF, title='OK'))
...
\n(🏴༒🔱 نمــࢪود 🔱༒)  𖣬 \n:『@M_T_F 』⏎'''
					...
					if "Diakses menggunakan Facebook" in re.findall("\<title\>(.*?)<\/title\>",str(cek)):
						...
						if "Anda tidak memiliki aplikasi atau situs web kedaluwarsa untuk ditinjau" in cek2:
							infoakun += (f"\nTidak Ada Aplikasi مـنتهي صلاحيتة Yang Terkait\n")
						else:
							hit1,hit2=0,0
							infoakun += (f"	Aplikasi مـنتهي صلاحيتة :\n")
...
def cek_SDMVIP(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[0m              ➛ %s"%(P,game[i].replace("مـنتهي صلاحيتة"," مـنتهي صلاحيتة")))
	except AttributeError:	 
